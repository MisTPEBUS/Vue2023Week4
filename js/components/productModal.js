    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content border-0">
        <div class="modal-header bg-dark text-white">
          ...
          <button type="button" class="btn-close" @click="productModal.hide()" aria-label="Close"></button>
        </div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-outline-secondary" @click="productModal.hide()">
            取消
          </button>
